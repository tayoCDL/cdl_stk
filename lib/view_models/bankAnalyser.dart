...
//       Uri.parse(AppUrl.getLoanDetails + passedLoanID.toString() + '?associations=all&exclude=guarantors,futureSchedule'),
//       headers:bHeader
//     );
//
...
//      Uri.parse( AppUrl.getSingleClient + newClientData['clientId'].toString() + '/banks'),
//       headers: bHeader,
//     );
...
//        Uri.parse( AppUrl.getSingleClient + newClientData['clientId'].toString()),
//         headers: bHeader
//       );
