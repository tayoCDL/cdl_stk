...
class AddLeadProvider extends ChangeNotifier {
  ...
  Future<Map<String, dynamic>> addPersonal(var personalData) async {
    var result;
   ...
   // return personalData;
    ...
    final Map<String, dynamic> clientData = {
        "id":personalData['id'],
      "leadSourceId": personalData['leadSourceId'],
      "leadCategoryId": personalData['leadCategoryId'],
      "leadTypeId": personalData['leadTypeId'],
      "locale": personalData['locale'],
      "expectedRevenueIncome": personalData['expectedRevenueIncome'],
      "leadRatingId": personalData['leadRatingId'],
      "moreInfo" : {
        "clients": {
          "id":personalData['clientId'],
          ...
          "emailAddress": personalData['emailAddress'],
           "officeId": personalData['id'] == null ? 1 : null,
          // "officeId": 1,
    ...
    final Map<String, dynamic> clientDataB = {
      "id":personalData['id'],
      "leadSourceId": personalData['leadSourceId'],
      "leadCategoryId": personalData['leadCategoryId'],
      "leadTypeId": personalData['leadTypeId'],
    ...
    try{
      Response responsevv = await post(
        AppUrl.addLead,
        body: json.encode(personalData['dateController'].isEmpty ? clientDataB : clientData),
        headers: {
      ...
      prefs.setString('prefsLeadPersonalData', jsonEncode(clientData));
  ...
  Future<Map<String, dynamic>> addEmployment(var employmentData) async {
    var result;
    ...
    final Map<String, dynamic> clientData = {
      "id": prefs.getInt('leadId') == null ? employmentData['leadId'] : prefs.getInt('leadId'),
    "moreInfo" : {
      "clients": {
      ...
      "clientEmployers": [
        {
         // 'id':prefs.getInt('employerResourceId') == null ? null : prefs.getInt('employerResourceId'),
          "id": employmentData['id'] == null ? null : employmentData['id'],
          "locale": "en",
          "dateFormat": "dd MMMM yyyy",
    ...
    try{
      ...
      Response responsevv = await post(
        AppUrl.addLead,
        body: json.encode( employmentData['employmentDate'].isEmpty || employmentData['salary_payday'].isEmpty ? clientDataB : clientData),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
      ...
      print('status body  ${responsevv.body}');
      if(responsevv.statusCode == 200 ){
        final Map<String, dynamic> responseData2 = json.decode(responsevv.body);
      ...
      if (e.toString().contains('SocketException') ||
        ...
        Map<String,dynamic> empsPrefs = {
          "leadSourceId": prefPersonals['leadSourceId'],
          "leadCategoryId": prefPersonals['leadCategoryId'],
          "leadTypeId": prefPersonals['leadTypeId'],
          "locale": prefPersonals['locale'],
          "expectedRevenueIncome": prefPersonals['expectedRevenueIncome'],
          "leadRatingId": prefPersonals['leadRatingId'],
        "moreInfo" : {
          "clients": {

            "firstname": prefPersonals['moreInfo']['clients']['firstname'],
            "lastname": prefPersonals['moreInfo']['clients']['lastname'],
            "middlename": prefPersonals['moreInfo']['clients']['middlename'],
            "activationChannelId": 57,
            "mobileNo" : prefPersonals['moreInfo']['clients']['mobileNo'],
            "emailAddress": prefPersonals['moreInfo']['clients']['emailAddress'],
            "officeId": 1,
            "genderId": prefPersonals['moreInfo']['clients']['genderId'],
            "locale": "en",
            "dateOfBirth": prefPersonals['moreInfo']['clients']['dateOfBirth'],
            "dateFormat": "dd MMMM yyyy",
            "staffId":prefs.getInt('staffId'),
            "titleId": prefPersonals['moreInfo']['clients']['titleId'],
            "bvn": prefs.getString('inputBvn'),
            'employmentSectorId':  prefPersonals['moreInfo']['clients']['employmentSectorId'],
            "numberOfDependent": prefPersonals['moreInfo']['clients']['numberOfDependent'],
            "educationLevelId": prefPersonals['moreInfo']['clients']['educationLevelId'],
            "maritalStatusId": prefPersonals['moreInfo']['clients']['maritalStatusId'],
            "doYouWantToUpdateCustomerInfo" : true,
            "isComplete": false
          },
          "clientEmployers": [
  ...
  Future<Map<String, dynamic>> addResidential(var residentialData) async {
    var result;

    _addStatus = Status.Sending;
    notifyListeners();

    print('residentialData ${residentialData}');
    ...
    final Map<String, dynamic> clientData = {
      "id": prefs.getInt('leadId') == null ? residentialData['leadId'] : prefs.getInt('leadId'),
    "moreInfo": {
      "clients": {
      ...
      "addresses" : [
        {
          "addressId": residentialData['id'] == null ? null : residentialData['id'],
          // "addressId": 423,
    ...
    print('residential Details ${residentialData['dateMovedIn'].isEmpty ? clientDataB : clientData}');
    ...
    try{
      ...
      Response responsevv = await post(
        AppUrl.addLead,
        body: json.encode(residentialData['dateMovedIn'].isEmpty ? clientDataB : clientData),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
      ...
      if (e.toString().contains('SocketException') ||
        ...
        "moreInfo" : {
          ...
          "clientEmployers": [
            {
              'id': prefs.getInt('employerResourceId') == null ? null : prefs
                  .getInt('employerResourceId'),
              "locale": "en",
              "dateFormat": "dd MMMM yyyy",
              "employmentDate": prefPersonals['moreInfo']['clientEmployers'][0]['employmentDate'],
              "emailAddress": prefPersonals['moreInfo']['clientEmployers'][0]['emailAddress'],
              "mobileNo": prefPersonals['moreInfo']['clientEmployers'][0]['mobileNo'],
              "employerId": prefPersonals['moreInfo']['clientEmployers'][0]['employerId'],
              "employerId": prefPersonals['moreInfo']['clientEmployers'][0]['staffId'],
              "countryId": 29,
              "stateId": prefPersonals['moreInfo']['clientEmployers'][0]['stateId'],
              "lgaId": prefPersonals['moreInfo']['clientEmployers'][0]['lgaId'],
              "officeAddress": prefPersonals['moreInfo']['clientEmployers'][0]['officeAddress'],
              "nearestLandMark": prefPersonals['moreInfo']['clientEmployers'][0]['nearestLandMark'],
              "jobGrade": prefPersonals['moreInfo']['clientEmployers'][0]['jobGrade'],
              "employmentStatusId": 50,
              "salaryRangeId": prefPersonals['moreInfo']['clientEmployers'][0]['salaryRangeId'],
              "active": true
            }
          ],
          "addresses": [
            {
              "addressId": prefs.getInt('residenceResourceId') == null
                  ? null
                  : prefs.getInt('residenceResourceId'),
              // "addressId": 423,
              "dateMovedIn": residentialData['dateMovedIn'],
              "locale": "en",
              "dateFormat": "dd MMMM yyyy",
       ...
       //
       //    prefs.remove('prefsLeadResidentials');
       //
       //    print('lead List ${listLead}');
       //
       //  // get the stringList as if it exists (Or IF null)
       // //  decode it to list<dynamic> then add the prefsResidential as string
       //  // save it back
       //
       //  print('prefsDee ${lils}');
       ...
       //  return result = {'status': false, 'message': 'Network_error','data':'No Internet connection'};
        ...
        var minGis =   prefs.setStringList('LeadDraftLists', listLead);
        prefs.remove('prefsLeadResidentials');
  ...
  Future<Map<String, dynamic>> addNextOfKin(var nextofKinData) async {
    var result;
  ...
  Future<Map<String, dynamic>> addBankDetails(var bankData) async {
    var result;
