...
class RetCodes {
  ...
  Future<dynamic> fetchCodes() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  print('responsestaff code ${responsevv.statusCode}');
    ...
    if (responsevv.statusCode == 200) {
      ...
      String? agentCode = responseData['agentCode'] as String?;
      if (agentCode != null) {
      ...
      Response responseAgent = await get(
          Uri.parse(AppUrl.clients_List + '?referralIdentity=${agentCode}'),
          headers: bHeader);
  ...
  Future<Map<String, dynamic>> clientAccount(String?  clientId,
    ...
    Response responsevv =
    await get(Uri.parse(AppUrl.clientAccount + '${clientId ?? ""}'), headers: bHeader);
    print('responsestaff code ${responsevv.statusCode}');
    if(responsevv.statusCode == 401){
      // result = {
      //   'data': null,
  ...
  Future<Map<String, dynamic>> getCodes(String?  valID) async {
    ...
    try {
      Response responsevv = await get(
        Uri.parse(AppUrl.getCodeValue + '${valID}/codevalues'),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
...
//  AppUrl.searchClient + '${name}',
    ...
    try {
      Response responsevv = await get(
       Uri.parse( AppUrl.newSeachClient + '${name}'),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> leadSearch(
    ...
    try {
      Response responsevv = await get(
       Uri.parse(AppUrl.getSequestTypePendingOnMe + '${staffId}?search${searchName}'),
        headers: {
          'Content-Type': 'application/json',
  ...
  Future<Map<String, dynamic>> Leademployers(String?  employerName) async {
   ...
   // print(AppUrl.allEmployers + '&name=${employerName}');
    try {
      Response responsevv = await get(
       Uri.parse(AppUrl.allEmployers + '&name=${employerName}'),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
  ...
  //  print(AppUrl.allEmployers + '&name=${employerName}');
    try {
      Response responsevv = await get(
       Uri.parse( AppUrl.employerProduct + '${employerId}/loanproducts'),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> ticketType(int?  affectedUserType) async {
    ...
    Response responsevv = await get(
     Uri.parse( AppUrl.ticketType + affectedUserType.toString()),
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer ${sequesttoken}',
      },
  ...
  Future<Map<String, dynamic>> categoryType(int?  ticketInt, int?  unitId) async {
    ...
    Response responsevv = await get(
     Uri.parse( AppUrl.categoryApi + '${ticketInt}/${unitId}/1'),
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer ${sequesttoken}',
      },
  ...
  Future<Map<String, dynamic>> getSubValues(
    ...
    try {
      Response responsevv = await get(
        Uri.parse(AppUrl.getCodeValue + '${firstValue}/codevalues/child/${secondValue}'),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> repayment_loan_products(
    ...
    Response responsevv = await get(
      Uri.parse(AppUrl.repaymentProductEngine + '&staffInSelectedOfficeOnly=false&templateType=individual&employerId=${employerId}'),
      headers: {
        'Content-Type': 'application/json',
        'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
        'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> getLoanMetrics(String?  params) async {
   ...
   // print('loan metrics URL ${AppUrl.loanMetrics + '${params}'}');
    ...
    Response responsevv = await get(
     Uri.parse( AppUrl.loanMetrics + '${params}'),
      headers: {
        'Content-Type': 'application/json',
        'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
        'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> getClientProfile(String?  clientID) async {
    ...
    Response responsevv = await get(
      Uri.parse(AppUrl.getSingleClient + clientID!),
      headers: {
        'Content-Type': 'application/json',
        'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
        'Authorization': 'Basic ${token}',
...
//  print('appUrl >> ${AppUrl.getRisksDetails + '?Bvn=${bvn}&ProductId=${productId}',}');
    try {
      Response responsevv = await get(
        Uri.parse(AppUrl.getRisksDetails + '?Bvn=${bvn}&ProductId=${productId}'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': APP_TOKEN!!,
        },
  ...
  Future<Map<String, dynamic>> getConfigForLoan(
    ...
    Response responsevv = await get(
     Uri.parse( AppUrl.getLoanDetails + '${loanID}'),
      headers: {
        'Content-Type': 'application/json',
        'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
        'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> sendLinkToCLient(
    ...
    Response responsevv = await get(
     Uri.parse( AppUrl.getLoanPaymentLinkMethod +
          '${loanID}' +
          '?command=${commandType}&mode=${mode}'),
      headers: {
        'Content-Type': 'application/json',
  ...
  Future<bool> isBvnAvailable(int?  clientId) async {
    ...
    try{
        ...
        Response responsevv = await get(
        Uri.parse ( AppUrl.lafDocument + '${loanID}'),
          headers: {
            'Content-Type': 'application/json',
            'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
            'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> lafDownoad(int?  loanID) async {
    ...
    Response responsevv = await get(
      //279 ${loanID}
      Uri.parse(AppUrl.lafDownload + '${loanID}' + '/download'),
      headers: {
        'Content-Type': 'application/json',
        'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
        'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> verifyLafOTP(int?  loanID, String?  OTPtoken) async {
    ...
    Response responsevv = await get(
     ...
     // AppUrl.getLoanDetails + '${loanID}' + '/laf/otp/' + OTPtoken + '/accept',
       Uri.parse( AppUrl.newVerifyOtp + '${loanID}' + '/${OTPtoken}?channelId=77'),
  ...
  Future<Map<String, dynamic>> addNote(
    ...
    if (methodType == 'post') {
      responsevv = await post(
       Uri.parse( AppUrl.getLoanDetails + '${loanID}' + '/notes'),
      ...
      responsevv = await put(
       Uri.parse( AppUrl.getLoanDetails + '${loanID}' + '/notes/${noteId}'),
        body: json.encode(note),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
  ...
  Future<Map<String, dynamic>> requestemployerValidation(
    ...
    Response responsevv = await get(
      Uri.parse(AppUrl.getSingleClient + '${clientID}' + '/employers/otp/' + mode!),
      headers: {
        'Content-Type': 'application/json',
        'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
        'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> bankStatementAnalyser(
    ...
    Response responsevv = await post(
      ...
      Uri.parse(AppUrl.getLoanDetails + clientId.toString() + '/decide'),
 ...
 //       print('from auth provider');
  ...
  Future<Map<String, dynamic>> new_loanRepaymentCalculator(
    ...
    try {
      Response responsevv = await post(
        AppUrl.newLoanRepaymentCalculator,
        body: json.encode(calculateReschedule),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
  ...
  Future<Map<String, dynamic>> getSttlement(
    ...
    try {
      ...
      Response responsevv = await get(
        Uri.parse(AppUrl.getLoanDetails +
  ...
  Future<Map<String, dynamic>> getApprovals(int?  loanID) async {
    ...
    try {
      Response responsevv = await get(
        Uri.parse(AppUrl.getApprovals + '${loanID}'),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> getEmployerInLoanView(
    ...
    try {
      Response responsevv = await put(
        Uri.parse(AppUrl.getLoanDetails + '${loanID}/employer'),
...
// loans/{loanId}/documents/all
    try {
      Response responsevv = await get(
        Uri.parse(AppUrl.getLoanDetails + '${loanID}/documents/all'),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
...
// URL: "https://40.113.169.208:8443/fineract-provider/api/v1/loans/268558/documents/base64/16405"
    try {
      Response responsevv = await get(
       Uri.parse(AppUrl.getLoanDetails + '${loanID}/documents/base64/${documentId}'),
        headers: {
          'Content-Type': 'application/json',
          'Fineract-Platform-TenantId': FINERACT_PLATFORM_TENANT_ID,
          'Authorization': 'Basic ${token}',
  ...
  Future<Map<String, dynamic>> addDocument(int?  loanID, var docObject) async {
    ...
    try {
      Response responsevv = await post(
        Uri.parse(AppUrl.getLoanDetails + '${loanID}/documents/bulkbase64'),
  ...
  Future<Map<String, dynamic>> getProductMetrics(
    ...
    try {
      ...
      Response responsevv = await get(
       Uri.parse( AppUrl.getProductMetrics + '${loanOfficerId}&cycleId=${cycleId}'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': PRODUCT_INFO_TOKEN!,
        },
    ...
    try {
      return await post(
        ...
        onTimeout: () {
          // _loggedInStatus = Status.NotLoggedIn;
          // notifyListeners();
          throw "Error, unable to post data to server";
        //  return null;
