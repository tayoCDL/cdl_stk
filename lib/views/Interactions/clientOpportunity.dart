...
class ClientOpportunity extends StatefulWidget {
  ...
  const ClientOpportunity({Key key,this.clientID,this.ClientEmail,this.clientName}) : super(key: key);
  @override
  _ClientOpportunityState createState() => _ClientOpportunityState(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Opportunities',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold),),
        centerTitle: true,
        actions: [
          IconButton(
            onPressed: (){
      ...
      floatingActionButton: FloatingActionButton(
          onPressed: (){
            MyRouter.pushPage(context, CreateOpportunity(
