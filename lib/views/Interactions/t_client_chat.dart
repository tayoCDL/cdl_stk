...
class TClientInteractionChat extends StatefulWidget {
  final String ticketID, test_title;
  const TClientInteractionChat(
      {Key key, @required this.ticketID, this.test_title})
      : super(key: key);

  @override
  _TClientInteractionChatState createState() => _TClientInteractionChatState(
      ticketID: this.ticketID, test_title: this.test_title);
// final User user;
}

class _TClientInteractionChatState extends State<TClientInteractionChat> {
  @override
  var discussData = [];
  var fullRequestData = {};
  ...
  String ticketID, test_title;
  _TClientInteractionChatState({this.ticketID, this.test_title});
        ...
        if (response['status'] == false) {
          ...
          if (response['message'] == 'Network_error') {
            ...
            return MyRouter.pushPageReplacement(
                context, TClientInteractionChat(ticketID: ticketID));
          }
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      '${getLoanResolutionDiscussion(2, 2).first}',
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Text(
                                          retsNx360dates('2021-09-10 12:00:00'),
  ...
  List<String> discussionArray = [
    "Verifying loan information for resolution.",
    "Contacting lender to discuss payment options.",
    "Reviewing repayment plans for your loan.",
    "Addressing discrepancies in loan records.",
    "Negotiating terms for loan settlement.",
    "Assessing eligibility for loan restructuring.",
    "Processing deferment request for your loan.",
    "Clarifying terms and conditions of the loan agreement.",
    "Resolving issues with loan documentation.",
    "Exploring alternatives for smoother loan repayment."
  ];

  List<String> getMyDiscussions(int count) {
    if (count <= 0) {
      return [];
    }
  ...
  List<String> loggerArray = [
    "Detected discrepancies in loan records. Investigating the root cause.",
    "Found issues with the repayment plan. Recommending adjustments for smoother resolution.",
    "Processing deferment request for the loan. Confirming eligibility criteria.",
    "Clarifying terms and conditions of the loan agreement. Resolving any confusion in documentation.",
    "Uncovered alternatives for loan repayment. Discussing options to ensure borrower satisfaction.",
  ];

  List<String> resolverArray = [
    "Acknowledged. Checking with the lender to validate the loan information.",
    "Understood. Reviewing the proposed adjustments and negotiating terms with the lender.",
    "Excellent. Communicating with the borrower to explain the deferment process.",
    "Appreciated. Providing clear explanations to the borrower for better understanding.",
    "Great. Exploring alternatives with the lender to find the most suitable resolution.",
  ];

  List<String> getLoanResolutionDiscussion(int loggerCount, int resolverCount) {
    List<String> selectedDiscussion = [];

    selectedDiscussion.addAll(_selectRandomPhrases(loggerArray, loggerCount));
    selectedDiscussion
        .addAll(_selectRandomPhrases(resolverArray, resolverCount));

    return selectedDiscussion;
  }

  List<String> _selectRandomPhrases(List<String> array, int count) {
