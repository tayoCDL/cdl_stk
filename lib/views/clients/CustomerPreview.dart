...
class _CustomerPreviewState extends State<CustomerPreview> {
  ...
  Widget build(BuildContext context) {
    var finalValidation = () async {
      ...
      Map<dynamic, dynamic> customerValidation = {
        "clients": {
      ...
      final Future<Map<String, dynamic>> respose =
          addClientProvider.finalClientValidation(customerValidation);
      ...
      respose.then((response) {
        ...
        if (response['status'] == false) {
          ...
          // MyRouter.pushPageReplacement(context, ViewClient(clientID: clientProfile['clients']['id'],));
                ...
                leading: IconButton(
                  onPressed: () {
                    MyRouter.pushPage(
                        context,
                        ViewClient(
                          clientID: clientProfile['clients']['id'],
                        ));
                  ...
                  background: CircleAvatar(
                    ...
                    child: Container(
                        ...
                        child: clientProfile['avatar'] == null ||
                            ...
                            ? Image.memory(
                                base64Decode(retRealFile(dummyAvatar)))
                                      ...
                                      MyRouter.pushPage(
                                          ...
                                          AddClient(
                                            ClientInt: clientProfile['clients']
                                                ['id'],
                                            // sector: clientProfile['clients']['firstname'],
                                            comingFrom: 'customerPreview',
                                            Passedbvn: clientProfile['clients']
                                                ['bvn'],
                                          ));
