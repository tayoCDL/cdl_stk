...
class LoginScreen extends StatefulWidget {
  ...
  State<LoginScreen> createState() =>
      _LoginScreenState(login_type: this.login_type!);
}
  ...
  Widget build(BuildContext context) {
    ...
    var doLogin = () {
      ...
      if (password.text.length < 2) {
        ...
        final Future<Map<String, dynamic>> respose = authProvider.login(
            username.text.trim(), password.text, login_type,
            isAgent: isAgent);
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Enter your official email address to continue',
                                style: kHeading_2,
                              ),
                              Text('')
                            ],
                              ...
                              Column(
                                ...
                                children: [
                                  TextInput(
                                    ...
                                    inputAction: TextInputAction.next, onButtonPressed: () {  },
