...
//             },
//           ),
//           title: const Text('App Permissions',style: TextStyle(color: Colors.black),),
//           actions: <Widget>[
//             // IconButton(
...
//
//       ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(serviceStatus.toString())));
