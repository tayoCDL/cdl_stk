...
int?  FEDG0_LOAN_ID = 30;
int?  DPL_LOAN = 36;
List<int> FINANCIAL_INCLUSION = [111];
int SELF_EMPLOYED = 3147;
String?  enc_key = '1234567812345678';
String?  enc_iv = 'S1mp7i4i3d@W!T>?';
//String?  payload = '2cRuDzs2javu4ltVaa2Wwsx/PQS/MLGYrtP4kc1rY7fx65Ekld2zwm+qcCaJ/DRiOs2Q5+HBPa5rY9VQ2BLlKaMOpcIulRKgcwselccntVJkATBkkFky5zyXUfUTALXz';
String?  payload = '2cRuDzs2javu4ltVaa2Wwsx/PQS/MLGYrtP4kc1rY7fx65Ekld2zwm+qcCaJ/DRiOs2Q5+HBPa5rY9VQ2BLlKaMOpcIulRKgcwselccntVJkATBkkFky5zyXUfUTALXz';
...
// int?  FEDG0_LOAN_ID = 71;
// int?  DPL_LOAN = 52;
// List<int> FINANCIAL_INCLUSION = [100,101];
// int SELF_EMPLOYED = 3147;
// String?  enc_key = '1234567812345678';
// String?  enc_iv = 'S2mp7i4i3d@W!T>?';
// //String?  payload = 't+Hs1jeW/fmMXAPCeXPVNkraWMOES0hDogJ1977h/ctOVMvrVP0xaPOMO00GrLSootSKvDGJFEvZfu6Sk6I5PYaimSbK9qeJJZHlmS4Y5Wk=';
// String?  payload = 'UWWPyOAr1bvwJJVdgrEnHlxvFRdRwi63vJgKsBvjm0eTTQzgkEPmG3zZXp7dvXikqLIwSH84aw8l8ltUL4r35HPAd23/U3H3ymMAvwwXnBDrghRvgRRSQmtNmKpJXdNNiE9sB4ii94XeOe9tWHO9/A==';
// String?  USSD_BEARER = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJDbGllbnRJZCI6IjM1IiwiZXhwIjoxODI0OTk3NTc3LCJpc3MiOiJodHRwczovL254d3JhcHBlci5jcmVkaXRkaXJlY3QubmcvYXBpLyIsImF1ZCI6Imh0dHBzOi8vbnh3cmFwcGVyLmNyZWRpdGRpcmVjdC5uZy9hcGkvIn0.Un8t82-vGmsdcZl_QoAO_8or4A46ALBRUIkOIDv0edw';
