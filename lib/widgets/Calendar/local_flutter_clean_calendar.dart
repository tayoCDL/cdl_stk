...
import 'simple_gesture.dart';
import 'calendar_tile.dart';
import 'clean_calendar_event.dart';
import 'date_utils_local.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // SizedBox(height: 5,),
          // Text('8:00 AM',style: TextStyle(color: Color(0xff707070),fontWeight: FontWeight.bold,fontSize: 17),),
          // SizedBox(height: 5,),
          // Row(
          //   children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Clocked In: ', style: TextStyle(fontWeight: FontWeight.w300,fontFamily: 'Nunito SansRegular',fontSize: 16)),
              Text(clockin,style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Nunito SansRegular',fontSize: 16),),
            ],
          ),
          SizedBox(height: 10,),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Clocked Out: ', style: TextStyle(fontWeight: FontWeight.w300,fontFamily: 'Nunito SansRegular',fontSize: 16)),
              Text(clockout,style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Nunito SansRegular',fontSize: 16),),
            ],
          ),
          SizedBox(height: 10,),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Location: ', style: TextStyle(fontWeight: FontWeight.w300,fontFamily: 'Nunito SansRegular',fontSize: 16)),
              Text(location,style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Nunito SansRegular',fontSize: 12),),
            ],
          ),
          SizedBox(height: 10,),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Is Device: ', style: TextStyle(fontWeight: FontWeight.w300,fontFamily: 'Nunito SansRegular',fontSize: 16)),
              Text('${isDevice}',style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Nunito SansRegular',fontSize: 16),),
            ],
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Activities',style: TextStyle(fontSize: 19,fontWeight: FontWeight.bold),),
                      Text('See All',style: TextStyle(color: Colors.blue),)
                    ],
                  ),
                  SizedBox(height: 15,),
                //  workCard(summary: event.summary,place: event.description),
                  workCard(clockin: event.clockIn,clockout: event.clockOut,location: event.location,isDevice: event.isDevice),
                  SizedBox(height: 15),
                 // workCard(summary: event.summary,place: event.description),
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Row(
            children: [
              _singleCard('assets/images/customers.png',"10","Attendance",),
              _singleCard('assets/images/customers.png',"10","Attendance"),
              _singleCard('assets/images/customers.png',"10","Attendance"),
              _singleCard('assets/images/customers.png',"10","Attendance"),
            ],
